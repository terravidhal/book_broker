            ...
            <div class="container-fluid text-center p-5" style="justify-content: center;width: 50%;">
               <div class="omikuji border-1">
                        <form:form action="/process_update/books/${bookObj.id}" method="PUT" modelAttribute="bookObj" class="form_this">
                            ...
                            <!--SENSEI BONUS : le livre reste emprunté mêm s'il est  update-->
                            <div class="form-row">
                                <form:errors path="borrower" class="error"/>
                                <form:input type="hidden" path="borrower" value="${borrowerUser.id}" class="form-control"/>
                            </div>
                        ...
                        <!--add-->
		                <a class="btn btn-danger my-2" href="/books/${bookObj.id}/delete">delete book</a>
                </div> 
